...
namespace FornecedorCrud.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,FornecedorCnpj,FornecedorEmail,FornecedorSenha,FornecedorName")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,FornecedorCnpj,FornecedorEmail,FornecedorSenha,FornecedorName")] Fornecedor fornecedor)
        {
